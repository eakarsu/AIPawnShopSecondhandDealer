...
export default function GapAuctionsWithoutAuctionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-auctions-without-auction/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Auctions without '/auction</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Auctions without /auction-price-suggest (optimize reserve price based on demand prediction)</p>
