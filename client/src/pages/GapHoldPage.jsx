...
export default function GapHoldPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-hold/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Hold</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Hold-periods without /expiration-optimize (identify items likely to expire unsold; suggest early sale)</p>
