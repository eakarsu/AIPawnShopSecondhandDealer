...
// Custom Feature: Customer segmentation + marketing
// Customer segmentation + marketing: AI identifies high-value customer cohorts; auto-generates personalized offers (e.g., \"We got in the guitar you liked...\"); SMS/email outreach
import React, { useState } from 'react';

export default function CFCustomerSegmentationMarketingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-customer-segmentation-marketing/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Customer segmentation + marketing</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Customer segmentation + marketing: AI identifies high-value customer cohorts; auto-generates personalized offers (e.g., \"We got in the guitar you liked...\"); SMS/email outreach</p>
