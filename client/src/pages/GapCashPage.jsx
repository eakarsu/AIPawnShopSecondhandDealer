...
export default function GapCashPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-cash/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Cash</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Cash-drawer without /theft-detection (flag unusual cash patterns or employee behavior)</p>
